...
CREATE TABLE `admin_applications_education` (
  ...
  `secondarySchoolGraduate` tinyint(1) DEFAULT NULL,
  ...
  `computerFluency` tinyint(1) DEFAULT NULL,
  `computerAccess` tinyint(1) DEFAULT NULL,
  `internetAccess` tinyint(1) DEFAULT NULL,
  `wordProcessingFluency` tinyint(1) DEFAULT NULL,
  `presentationFluency` tinyint(1) DEFAULT NULL,
...
CREATE TABLE `admin_applications_health` (
  ...
  `learningDifficulties` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci,
  `healthAccessibilityCircumstances` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci,
  ...
  `firstEmergencyContactRelationship` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci,
  ...
  `secondEmergencyContactRelationship` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci,
...
CREATE TABLE `admin_applications_personal` (
  ...
  `sex` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
